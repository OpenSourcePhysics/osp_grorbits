...
class InitialConditionsRainL extends InitialConditionsL{
  ...
  /**
   * According to known values of initial r, phi, invB, and sign 
   * it adjusts value theta0.
   */
  ...
  /**
   * According to known values of initial r, phi, theta0 
   * it adjusts values of invB and sign.  
   */
